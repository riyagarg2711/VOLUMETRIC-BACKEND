...
func (r *ScanRepo) GetUserScans(userID uuid.UUID) ([]model.ScanSummary, error) {
	...
	defer rows.Close() // Closes DB cursor after function finishes.Prevents memory leaks.
